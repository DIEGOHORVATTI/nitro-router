...
router.get('/users', async (ctx, res) => {
...
router.get('/users/:id', async (ctx, res) => {
...
router.post('/users', async (ctx, res) => {
...
router.put('/users/:id', async (ctx, res) => {
  const userId = parseInt(ctx.params.id)
...
router.delete('/users/:id', async (ctx, res) => {
  const userId = parseInt(ctx.params.id)
