...
publicRoutes.get('/', async (ctx, res) => {
...
publicRoutes.get('/:id', async (ctx, res) => {
...
protectedRoutes.post('/', async (ctx, res) => {
...
protectedRoutes.put('/:id', async (ctx, res) => {
  const postId = parseInt(ctx.params.id)
...
adminRoutes.delete('/:id', async (ctx, res) => {
  const postId = parseInt(ctx.params.id)
  const { user, requestId } = ctx
